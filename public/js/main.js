...
(function () {
    ...
    JM_UPLOAD.prototype={
        ...
        'onprog':function (loaded,total) {
            var percent=document.getElementById('per');
            percent.innerHTML=parseInt(loaded/total)*100+'%';
        },
        ...
        'fn_uploadFiles':function () {
            ...
            if(len>0){
                ...
                xhr.onprogress=function (e) {
                    var ev=JM.getEvent(e);
                    self.onprog(ev.loaded,ev.total);
                };
    ...
    function createPicUploads(obj) {
        var  html='<div id="uploadPics">' +
            ...
            '<p>温馨提示：一次最多上传10张图片。&nbsp;&nbsp;<span>上传进度:</span><small id="per"></small></p>'+
            '<div>'+
